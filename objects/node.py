...
class Add(_BinSidedOperator, Generic[LHSNodeT, RHSNodeT]):
    pass


class Sub(_BinSidedOperator, Generic[LHSNodeT, RHSNodeT]):
    pass


class Mul(_BinSidedOperator, Generic[LHSNodeT, RHSNodeT]):
    pass


class Div(_BinSidedOperator, Generic[LHSNodeT, RHSNodeT]):
    pass


class Pow(_BinSidedOperator, Generic[LHSNodeT, RHSNodeT]):
    pass
